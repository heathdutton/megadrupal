...
<div class="clearfix" id="compGroupB">      
  ...
  <form style="margin-top: 1em;">
      <div id="radioset">
          <input type="radio" name="radio" id="radio1"><label for="radio1">Choice 1</label>
          <input type="radio" checked="checked" name="radio" id="radio2"><label for="radio2">Choice 2</label>
          <input type="radio" name="radio" id="radio3"><label for="radio3">Choice 3</label>
      </div>
  </form>
  ...
  <div>
      <input title="type &quot;a&quot;" style="z-index: 100; position: relative;" id="autocomplete">
  </div>
