...
According to the documentation (https://github.com/zeroclipboard/zeroclipboard)
Zero Clipboard:

    "...[is a] library provides an easy way to copy text to the clipboard using
    an invisible Adobe Flash movie and a JavaScript interface. The "Zero"
    signifies that the library is invisible and the user interface is left
    entirely up to you."
...
2) Download the Zero Clipboard 2.x project files into your 'libraries' directory
(usually /sites/all/libraries). Visit the GitHub page above or use this link:
https://github.com/zeroclipboard/zeroclipboard/archive/1.x-master.zip
extract and be sure the resulting directory is named "zeroclipboard".
