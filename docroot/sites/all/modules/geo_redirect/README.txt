...
2. Enable Geo Redirect module at admin/modules.

----------------------USAGE-------------------------------------------------------------------------------

1. Go to Configuration > Search and Metadata > Geo redirect URLs to add Redirect URLs or
simply go to admin/config/search/geo-redirect.

2. Click on Add geo redirect link to add redirect URLs.
