...
Drupal.pathMetatagsUI = Drupal.pathMetatagsUI || {};

(function($) {

  Drupal.behaviors.pathMetatagsUI = {
    attach: function(context) {

      $('.metatags-tokens .form-text', context).once(function() {
        new Drupal.pathMetatagsUI.autocomplete(this);
      });
  ...
  /**
   * pathMetatagsUI autocomplete object.
   */
  Drupal.pathMetatagsUI.autocomplete = function(input) {
    this.uri = 'asd';
    ...
    // Save the current pathMetatagsUI object, so it can be used in
    // handlers.
    var instance = this;
    ...
    this.jqObject.autocomplete("option", "source", function(request, response) {
      ...
      var $machineName = Drupal.settings.pathMetatagsUI.machineName;
      var $basePath = Drupal.settings.basePath;

      $.ajax( {
        url: $basePath + 'path_metatags_ui/' + $machineName + '/' + encodeURIComponent(request.term),
        dataType: 'json',
  ...
  /**
   * Success function for pathMetatagsUI autocomplete object.
   */
  Drupal.pathMetatagsUI.autocomplete.prototype.success = function(data, request, response) {
    var list = new Array();
   ...
   */
  Drupal.pathMetatagsUI.autocomplete.prototype.open = function(searchFor) {
   ...
   */
  Drupal.pathMetatagsUI.autocomplete.prototype.close = function() {
   ...
   */
  Drupal.pathMetatagsUI.autocomplete.prototype.toggle = function() {
