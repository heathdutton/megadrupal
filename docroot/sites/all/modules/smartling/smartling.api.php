...
function hook_smartling_settings_form_info() {
  $forms = array(
    ...
    'smartling_admin_node_translation_settings_form' => array('weight' => 0, 'title' => t('Nodes settings')),
    'smartling_admin_entities_translation_settings_form' => array('weight' => 0, 'title' => t('Entities settings')),
  );

  if (module_exists('taxonomy')) {
    $forms['smartling_admin_taxonomy_translation_settings_form'] = array('weight' => 0, 'title' => t('Taxonomy vocabularies and fields'));
  }
