...
class FileUploadParameterBuilder {
  ...
  /**
   * version of a module and type of SDK (PHP/Java/...)
   *
   * @var string
   */
  protected $_clientLibId = "";
  ...
  public function __construct() {
    $this->_parametersArray = array(
      ...
      'smartling.client_lib_id' => $this->_clientLibId,
    );
  }
  ...
  /**
   * set parameter clientLibId
   *
   * @param string $clientLibId
   */
  public function setClientLibId($clientLibId) {
    $this->_clientLibId = $clientLibId;
    $this->_parametersArray['smartling.client_lib_id'] = $clientLibId;
    return $this;
  }
