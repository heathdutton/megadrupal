...
The 7.x-2.x branch was created by Darren "Dee" Lee (DeeZone: http://drupal.org/user/288060) and Peter Lehrer (plehrer: http://drupal.org/user/2257350). 8.x-2.14 conversion is by Earl Fong (tz_earl: http://drupal.org/user/2531114).
