...
You can pass a 3rd parameter to jump_quickly() that specifies whether to base
the default selection in the jump menu on the currently viewed page.  Examples
