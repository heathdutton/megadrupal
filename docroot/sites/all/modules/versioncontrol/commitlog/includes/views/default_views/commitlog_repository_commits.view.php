...
$handler->display->display_options['arguments']['repo_id']['title_enable'] = TRUE;
$handler->display->display_options['arguments']['repo_id']['title'] = 'Repository %1 commits';
...
$handler->display->display_options['fields']['nothing_2']['alter']['text'] = 'commitlog/commit/!1/[revision_1]';
