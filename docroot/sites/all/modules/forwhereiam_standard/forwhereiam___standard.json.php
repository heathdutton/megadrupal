 ...
 */
function forwhereiam___standard_findme_ajax($json_encode=true) {
 ...
 */
function forwhereiam___standard_search_ajax($json_encode=true) {
 ...
 */
function forwhereiam___standard_details_ajax($json_encode=true) {
 ...
 */
function forwhereiam___standard_rate_ajax($json_encode=true) {
