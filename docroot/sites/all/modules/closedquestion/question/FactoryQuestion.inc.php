...
/**
 * @file
 * Factory methods for creating questions from XML and loading UserAnswer
 * objects for arbitrary questions.
 */
 ...
 * @param int $nid
 *   The node id of the node to load the answers for.
 * @param int $uid
 *   The user id of the user to load the answers for.
 * @return CqUserAnswerDefault
 *   The UserAnswer object for the given nid and uid.
 */
function &closedquestion_get_useranswer($nid, $uid) {
  static $cache = array();
  ...
  $userAnswer = new CqUserAnswerDefault($nid, $uid);
