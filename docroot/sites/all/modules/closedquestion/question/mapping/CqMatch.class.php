...
class CqMatch extends CqAbstractMapping {
   ...
   */
  private function evaluateHotspots($hotspotPattern, $draggablePattern, $matchAll = FALSE, $timeStart = '', $timeEnd = '') {
   ...
   *
   * @param number $assessed_time
   *   The time being assessed
   * @param number $timeIntervalStart
   *   The start of the time interval
   * @param number $timeIntervalEnd
  ...
  private function evaluateTimeInterval($assessed_time = '', $timeIntervalStart = '', $timeIntervalEnd = '') {
    // print_r(array($assessed_time , (string) $timeIntervalStart , (string) $timeIntervalEnd ));
    if ($assessed_time == '' || $timeIntervalStart == '') {
      return true; //no time interval
    }
    ...
    //echo $returnValue === false ? 'false' : 'true';
