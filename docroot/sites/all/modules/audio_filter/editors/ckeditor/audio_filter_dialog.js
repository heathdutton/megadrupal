/**
 * @file audio_filter ckeditor dialog helper
 */

var audio_filter_dialog = {};
(function ($) {
audio_filter_dialog = {
  init : function() {
    //Get CKEDITOR
  ...
  insert : function() {
    ...
    if(params.file_url == "") {
      ...
      CKEDITOR.tools.callFunction(editor._.audio_filterFnNum, params, editor);
      window.close();
    }
  },
...
$(document).ready(function() {
  ...
  audio_filter_dialog.init();

  $('#edit-insert').click(function() {
    audio_filter_dialog.insert();
    return false;
  });
