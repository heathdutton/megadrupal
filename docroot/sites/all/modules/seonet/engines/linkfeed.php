...
class LinkfeedClient {
    ...
    function LinkfeedClient($options = null) {
        ...
        if (isset($options['folder'])) {
            $this->lc_folder = $options['folder'];
        }
        else {
            $this->lc_folder = dirname(__FILE__);
        }
    ...
    function load_links() {
        if ($this->lc_multi_site) {
            $this->lc_links_db_file = $this->lc_folder . '/linkfeed.' . $this->lc_host . '.links.db';
        } else {
            $this->lc_links_db_file = $this->lc_folder . '/linkfeed.links.db';
        }
