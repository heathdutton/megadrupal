 ...
 * For a full description of the module, visit the project page:
   https://www.drupal.org/sandbox/yuriy.kostin/2385113
 ...
 * Install as you would normally install a contributed Drupal module. See:
   https://drupal.org/www.drupal.org/sandbox/yuriy.kostin/2385113 for
   further information.
...
----------------
 ...
 - Management menu: '[Administartor command prefix] [Management menu item]',
     where [Administartor command prefix] is an option that set at
