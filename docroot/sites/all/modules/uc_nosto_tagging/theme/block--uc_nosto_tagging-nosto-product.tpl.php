...
<?php if(isset($nosto_product) && is_object($nosto_product)): ?>
  <div class="nosto_product" style="display:none">
    <span class="url"><?php print check_plain($nosto_product->page_url); ?></span>
    ...
    <?php if(!empty($nosto_product->image_url)): ?>
      <span class="image_url"><?php print check_plain($nosto_product->image_url); ?></span>
    <?php endif; ?>
    ...
    <?php if(!empty($nosto_product->description)): ?>
      <span class="description"><?php print check_plain($nosto_product->description); ?></span>
    <?php endif; ?>
