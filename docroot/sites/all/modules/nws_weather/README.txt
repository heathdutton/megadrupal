...
is contained in nws_weather.module. Please notice that the passed array contains weather values only, not key/value pairs like
the array of options in the code. It is left to the developer to parse the array that is returned.

Also note that this module has hardcoded the SOAP call to use 'e'nglish units. Future versions of this module may include support for 'm'etric units in the SOAP call.
