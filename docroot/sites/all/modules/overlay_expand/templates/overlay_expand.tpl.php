...
/**
 * @file
 * Theme implementation to display a page in the overlay_expand.
 *
 * Available variables:
...
<div id="overlay" <?php print $attributes; ?>>
  <div id="overlay-titlebar" class="clearfix">
    ...
    <div id="overlay-expand-wrapper">
      <a id="overlay-expand" href="#" target="_top" class="overlay-expand"><span class="element-invisible"><?php print t('Load this page without the overlay'); ?></span></a>
    </div>
