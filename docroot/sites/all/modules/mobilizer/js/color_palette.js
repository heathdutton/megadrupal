jQuery(document).ready(function (){
	...
	jQuery('.customize_done_btn').click(function(){
		...
		jQuery('.palette_border').removeClass("palette_border_active");
   	  	...
   	  	// this is added for preview loader displaying (added by Pankaj Chauhan)
   	    mobilizer_color_palette_inprogress_message();
    ...
    /**
     * mobilizer color palette inprogress message
     */
	function mobilizer_color_palette_inprogress_message(){
		// this is added for preview loader displaying (added by Pankaj Chauhan)
   	    jQuery('#iframe_div').html("<div class='preview-inprogress-cs'> Preview will be display in few second.. </div>");
	...
	jQuery('.customize_done_btn_text').click(function(){
		...
		jQuery('.selected_palette_text_color_cs').attr('style', 'background-color: ' + jQuery("#edit-text").val());
		jQuery('.selected_palette_link_cs').attr('style', 'background-color: ' + jQuery("#edit-link").val());
...
function set_default_color_for_style(){	
	...
	if(mobilizer_style){
		...
		mobilizer_flag_current_palette = color_platte_name;
