...
function proofread_bot_check_api($text) {
	...
	define('PROOFREADBOT_USERNAME', variable_get('proofread_bot_username', ''));
	define('PROOFREADBOT_PASSWORD', variable_get('proofread_bot_password', ''));
		
	$api = new DrupalREST('http://proofreadbot.com/server/', PROOFREADBOT_USERNAME, PROOFREADBOT_PASSWORD, TRUE);
	...
	if (isset($result_body->form_errors))
		{
		print($result_body->form_errors->content);
