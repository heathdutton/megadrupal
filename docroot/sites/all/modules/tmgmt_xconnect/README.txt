...
Global Content Management (GCM) language services : http://goo.gl/qyNDua.
...
* $conf['tmgmt_xconnect_<service>_order_client_id'] : The client ID.
* $conf['tmgmt_xconnect_<service>_order_due_date'] : What is the deadline for
  the file(s) to be translated. The deadline should be set in number of days
  from the moment the translation is ordered.
* $conf['tmgmt_xconnect_<service>_order_issued_by'] : The email address of the,
  by the translation known, issuer of the translation.
* $conf['tmgmt_xconnect_<service>_order_is_confidential'] : Is the content for
  the translation confidential?
* $conf['tmgmt_xconnect_<service>_order_needs_confirmation'] : Should there be a
  conformation send when the translation is ready?
* $conf['tmgmt_xconnect_<service>_order_needs_quotation'] : Should a quotation
  be created and send before the translation is performed?
...
* $conf['tmgmt_xconnect_<translator>_connection_timeout'] : The GCM service server
  timeout in milliseconds.
* $conf['tmgmt_xconnect_<translator>_connection_port'] : The GCM service server
  port number.
