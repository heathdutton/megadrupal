...
/**
 * @file
 * Contains ContextioAccountStorage.
 */

namespace Drupal\fluxcontextio;

//use Contextio\OAuth\Storage\StorageInterface;
//use Contextio\Exception;

/**
 * Storage class storing information in the account entity.
 */
class ContextioAccountStorage implements StorageInterface {
   ...
   * @var string
   */
  protected $namespace = 'fluxcontextio';
