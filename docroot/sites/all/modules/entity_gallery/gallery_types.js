...
Drupal.behaviors.galleryTypes = {
  attach: function (context) {
    ...
    $('fieldset#edit-workflow', context).drupalSetSummary(function(context) {
      var vals = [];
      $("input[name^='entity_gallery_options']:checked", context).parent().each(function() {
        vals.push(Drupal.checkPlain($(this).text()));
      });
      if (!$('#edit-entity-gallery-options-status', context).is(':checked')) {
    ...
    $('fieldset#edit-display', context).drupalSetSummary(function(context) {
      ...
      if (!$('#edit-entity-gallery-submitted', context).is(':checked')) {
