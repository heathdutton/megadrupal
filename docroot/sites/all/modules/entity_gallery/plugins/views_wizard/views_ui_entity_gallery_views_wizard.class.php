...
/**
 * @file
 * Definition of ViewsUiEntityGalleryViewsWizard.
 */

/**
 * Tests creating entity gallery views with the wizard.
 */
class ViewsUiEntityGalleryViewsWizard extends ViewsUiBaseViewsWizard {
    ...
    switch ($row_plugin) {
      ...
      case 'teasers':
        $style_form['row_options']['links'] = array(
          ...
          '#title' => t('Should links be displayed below each gallery'),
          '#options' => array(
  ...
  protected function default_display_options($form, $form_state) {
    ...
    $display_options['access']['perm'] = 'access entity galleries';
    ...
    $display_options['fields']['title']['table'] = 'entity_gallery';
    ...
    $display_options['fields']['title']['link_to_entity_gallery'] = 1;
  ...
  protected  function display_options_row(&$display_options, $row_plugin, $row_options) {
    switch ($row_plugin) {
      case 'full_posts':
        $display_options['row_plugin'] = 'entity_gallery';
      ...
      case 'titles_linked':
        ...
        $display_options['field']['title']['link_to_entity_gallery'] = 1;
        break;
      case 'titles':
        $display_options['row_plugin'] = 'fields';
        $display_options['field']['title']['link_to_entity_gallery'] = 0;
        break;
    }
  }
}
