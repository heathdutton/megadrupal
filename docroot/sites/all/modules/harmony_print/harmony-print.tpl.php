...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="<?php print $language->language; ?>" version="XHTML+RDFa 1.0" dir="<?php print $language->dir; ?>">
  ...
  <body class="harmony-print">
    ...
    <p />
    <div class="print-breadcrumb"><?php print theme('print_breadcrumb', array('node' => $entity)); ?></div>
    <hr class="print-hr" />
    ...
    <?php if ($sourceurl_enabled): ?>
      <div class="print-source_url">
        <?php print theme('print_sourceurl', array('url' => $source_url, 'node' => $entity, 'cid' => NULL)); ?>
      </div>
    <?php endif; ?>
