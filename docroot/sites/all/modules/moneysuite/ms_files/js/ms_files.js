...
function ms_files_expiration_disable_check(granularity, quantity) {
...
function ms_files_delete_list_populate() {
  $('.affected-file-name').empty().append(ms_files_list[$('#edit-recurse-directories').attr('checked')]);
}

$(document).ready(
  function() {
    ms_files_expiration_disable_check('#edit-uc-file-download-limit-duration-granularity', '#edit-uc-file-download-limit-duration-qty');
    ms_files_expiration_disable_check('#edit-download-limit-duration-granularity', '#edit-download-limit-duration-qty');
    ms_files_expiration_disable_check('#edit-download-limit-duration-granularity', '#edit-download-limit-duration-qty');
    ms_files_delete_list_populate();
...
Drupal.behaviors.ucFileSelectAll = function(context) {
  $('#ms_files_select_all:not(.ucFileSelectAll-processed)', context).addClass('ucFileSelectAll-processed').click(
    function() {
...
Drupal.behaviors.ucFileSelectNone = function(context) {
  $('#ms_files_select_none:not(.ucFileSelectNone-processed)', context).addClass('ucFileSelectNone-processed').click(
    function() {
...
function ms_files_update_download(id, accessed, limit) {
