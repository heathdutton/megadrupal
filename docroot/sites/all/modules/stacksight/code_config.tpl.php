...
<span class="code-red">define</span>(<span class="code-yellow">'STACKSIGHT_APP_ID'</span>, <span class="code-yellow">'<?php echo $data['_id'] ?>'</span>);
<span class="code-red">define</span>(<span class="code-yellow">'STACKSIGHT_TOKEN'</span>, <span class="code-yellow">'<?php echo $data['token'] ?>'</span>);
<span class="code-red">require_once</span>(<span class="code-blue">DRUPAL_ROOT</span> . <span class="code-yellow">'/<?php echo $data['module_path']; ?>'</span> . <span class="code-yellow">'/stacksight-php-sdk/bootstrap-drupal.php'</span>);
