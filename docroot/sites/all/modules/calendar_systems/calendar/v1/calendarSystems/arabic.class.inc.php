...
* 
*/
class cmfcCalendarV1Arabic extends cmfcCalendarV1 implements cmfcCalendarV1Plugin {
    ...
    */
	...
	function getStrings() {
		$stringGroups = array(
			'monthsName' => array('ar'=>$this->_monthsName),
			'monthsShortName' => array('ar'=>$this->_monthsShortName),
			'weeksName' => array('ar'=>$this->_weeksName),
			'weeksShortName' => array('ar'=>$this->_weeksShortName),
			'meridiemsName' => array('ar'=>$this->_meridiemsName),
			'meridiemsShortName' => array('ar'=>$this->_meridiemsShortName)
	    );
        return $stringGroups;
    }
}