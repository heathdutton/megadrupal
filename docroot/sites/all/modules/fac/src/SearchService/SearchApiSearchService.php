...
class SearchApiSearchService extends AbstractSearchService {
  ...
  public function configurationForm(array $form, array &$form_state) {
    ...
    if (!empty($search_api_indexes)) {
      ...
      if (isset($settings['index_id'])) {
        ...
        // Add a form field to configure on which full textfields to search for
        // matches.
      ...
      // For each bundle of the entity type check if the bundle can be selected
      // based on the configuration of the bundle filter that might be enabled
      ...
      drupal_set_message('You have not created or enabled any Search API indexes yet!', 'warning');
    }
  ...
  public function configurationFormSubmit(array $form, array &$values, array &$form_state) {
    $settings = array(
      ...
      'full_text_fields' => $values['full_text_fields'],
