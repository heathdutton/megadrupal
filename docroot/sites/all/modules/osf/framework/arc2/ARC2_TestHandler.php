...
class ARC2_TestHandler extends ARC2_Class {
  ...
  function isSameConstructResult($qr, $result, $result_base, $test) {
    ...
    if (in_array($test, array(/* manually checked 2007-09-21 */
      'http://www.w3.org/2001/sw/DataAccess/tests/data-r2/osf/manifest#construct-1',
      'http://www.w3.org/2001/sw/DataAccess/tests/data-r2/osf/manifest#construct-2',
      'http://www.w3.org/2001/sw/DataAccess/tests/data-r2/osf/manifest#construct-3',
      'http://www.w3.org/2001/sw/DataAccess/tests/data-r2/osf/manifest#construct-4',
      'http://www.w3.org/2001/sw/DataAccess/tests/data-r2/osf/manifest#construct-5',
    ))) {
      $pass = 1;
    }
