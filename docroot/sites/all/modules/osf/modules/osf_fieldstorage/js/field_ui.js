  ...
  attachUpdateSelects: function(table, settings) {
    ...
    $('.field-type-select', table).each(function () {
      ...
      $(this).bind('change keyup', function () {
        ...
        // Special handling for the OSF FieldStorage module.
        // We make sure to only add the widgets that are known to be working
        // with this module.
        if(this.id == 'edit-fields-add-new-field-osf-fieldstorage-type')
        {
          var widgetTypesOSFFieldStorage = {
            "list_text": {
            ...
            "text": {
              ...
              "osf_field_entity_reference" : "OSF Entity Reference",
              "osf_field_concept_reference" : "OSF Concept Reference (Tagging)",
              "autocomplete_widgets_suggested": "Autocomplete for predefined suggestions",
            },
            "date": {
              "date_select": "Select list",
              "date_text": "Text field"
            },
            "datestamp": {
              "date_select": "Select list",
              "date_text": "Text field"
            ...
            "entityreference": {
              ...
              "entityreference_autocomplete_tags": "Autocomplete (Tags style)",
              "options_select": "Select list",
              "options_buttons": "Check boxes/radio buttons"
            },
            "field_example_rgb": {
              "field_example_text": "RGB value as #ffffff",
              "field_example_3text": "RGB text field",
              "field_example_colorpicker": "Color Picker"
            },
            "file": {
              "file_generic": "File"
            },
            ...
            "geolocation_latlng": {
              "geolocation_googlemap": "Google Map",
              "geolocation_text": "Latitude/Longitude"
            }
          };

          options = (selectedFieldType in widgetTypesOSFFieldStorage ? widgetTypesOSFFieldStorage[selectedFieldType] : []);
        }        
...
jQuery.fn.fieldUIPopulateOptions = function (options, selected) {
  return this.each(function () {
    ...
    {
      $(this).html(html).attr('disabled', null);
    }
  });
};
