/* Come from RDFUI part of the RDFX project */

(function ($) {

Drupal.behaviors.osf_fieldstorageFieldsetSummaries = {
  attach: function (context) {
    ...
    $(document).bind('state:visible', function () {
      Drupal.behaviors.osf_fieldstorageFieldsetSummaries.attach($(this).closest('fieldset.rdf-field')[0])
    })
  }
};
