  ...
  Autocomplete.prototype = {
    ...
    getSuggestions: function(q) {
      ...
      if (cr && $.isArray(cr.suggestions)) {
        ...
        toggleWaitingIcon(me.options.iconID);
        ...
        //me.options.params.attributes = me.options.params.attributes + "::*" + q + "**";
        me.options.params.attributes = me.options.params.attributes + "::" + q + "*";
        ...
        $.ajax({
          ...
          success: function(txt){
            ...
            for(var i = 0; i < resultset.subjects.length; i++)        
            {
              ...
              if(loadedOntologiesNames[resultset.subjects[i].getPredicateValues("http://purl.org/dc/terms/isPartOf")[0].uri] != undefined)
              {
                fromOntology = loadedOntologiesNames[resultset.subjects[i].getPredicateValues("http://purl.org/dc/terms/isPartOf")[0].uri];
              }
...
//      } catch (err) { return; }
    ...
    select: function(i) {
      ...
      if (selectedValue) { 
        ...
        selectedValue = selectedValue.substring(0, selectedValue.search("&nbsp;&nbsp;&nbsp;"));            
