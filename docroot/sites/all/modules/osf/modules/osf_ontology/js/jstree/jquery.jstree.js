...
(function ($) {
	...
	$.jstree.plugin("search", {
        ...
        /**
        * @PATCH fgiasson 2011-08-11
        * 
        * This patch automatically select the node that got found.
        */
        for(var i = 0; i < this.data.search.result.length; i++)
        {
          if(this.data.search.result[i].lastChild.wholeText == str)
          {
            //this.data.search.result[i].click();
            $("#"+this.data.search.result[i].parentNode.id).children("a").click();
            $("#"+this.data.search.result[i].parentNode.id).children("a").addClass("jstree-search");
          }
        }
        ...
        * @PATCH fgiasson 2011-08-11
        * 
        * This patch just highlight the node that have the exact title.
        */
                
				this.data.search.result.parents(".jstree-closed").each(function (str) {
          t.open_node(this, false, true);
				});
