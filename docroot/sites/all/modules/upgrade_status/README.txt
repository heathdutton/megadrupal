...
1) search the modules' issue queue for already existing issues that might
   ...
   https://drupal.org/patch/apply for further information.

2) go ahead and install Coder module (https://drupal.org/project/coder), use its
   ...
   See https://drupal.org/patch/create for further information.

If you've checked your projects out from Git, you will need the Git Deploy
module (http://drupal.org/project/git_deploy) in order for this module to be
...
Bug reports, feature suggestions and latest developments:
  https://drupal.org/project/issues/upgrade_status
