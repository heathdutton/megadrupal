...
(function ($) {
  ...
  Drupal.behaviors.attachRange = {
    attach: function (context, settings) {
      var $minWeight = $(".field-name-socolissimo-flex-min-weight input");
      var $maxWeight = $(".field-name-socolissimo-flex-max-weight input");
      var $rangeSlider = $("#socolissimo-range-slider");
