README file for the Client-side adaptive background image module for Drupal.
Based on cs_adaptive_image module.

-- DESCRIPTION --

The Client-side adaptive background image module helps build responsive web
