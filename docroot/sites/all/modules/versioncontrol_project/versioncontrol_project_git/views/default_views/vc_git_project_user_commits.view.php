...
$view->description = 'VersionControl Project User Commit Log (Git)';
$view->tag = 'VersionControl Core';
$view->base_table = 'versioncontrol_operations';
$view->human_name = 'vc_git_project_user_commits';
$view->core = 0;
...
/* Field: Versioncontrol Git Operations: Attribution (git) */
$handler->display->display_options['fields']['attribution_1']['id'] = 'attribution_1';
$handler->display->display_options['fields']['attribution_1']['table'] = 'versioncontrol_git_operations';
$handler->display->display_options['fields']['attribution_1']['field'] = 'attribution';
$handler->display->display_options['fields']['attribution_1']['label'] = '';
$handler->display->display_options['fields']['attribution_1']['exclude'] = TRUE;
$handler->display->display_options['fields']['attribution_1']['element_label_colon'] = FALSE;
...
$handler->display->display_options['fields']['nothing']['ui_name'] = 'Commit header';
...
$handler->display->display_options['fields']['nothing']['alter']['text'] = '<div class="commit-global">
  ...
  <div class="attribution">[attribution_1]</div>
</div>';
...
/* Contextual filter: VersionControl Operations: Attribution */
$handler->display->display_options['arguments']['attribution']['id'] = 'attribution';
$handler->display->display_options['arguments']['attribution']['table'] = 'versioncontrol_operations';
$handler->display->display_options['arguments']['attribution']['field'] = 'attribution';
$handler->display->display_options['arguments']['attribution']['default_action'] = 'not found';
$handler->display->display_options['arguments']['attribution']['exception']['title_enable'] = TRUE;
$handler->display->display_options['arguments']['attribution']['title_enable'] = TRUE;
$handler->display->display_options['arguments']['attribution']['title'] = 'Commits by %1';
$handler->display->display_options['arguments']['attribution']['default_argument_type'] = 'fixed';
$handler->display->display_options['arguments']['attribution']['summary']['format'] = 'default_summary';
$handler->display->display_options['arguments']['attribution']['specify_validation'] = TRUE;
...
$handler->display->display_options['row_options']['creator_field'] = 'author_1';
...
$handler->display->display_options['fields']['attribution_1']['label'] = '';
$handler->display->display_options['fields']['attribution_1']['element_label_colon'] = FALSE;
$handler->display->display_options['fields']['attribution_1']['plain_text_output'] = 1;
/* Field: VersionControl Operations: List of label this operation is in */
$handler->display->display_options['fields']['labels']['id'] = 'labels';
$handler->display->display_options['fields']['labels']['table'] = 'versioncontrol_operations';
$handler->display->display_options['fields']['labels']['field'] = 'labels';
...
$handler->display->display_options['fields']['nothing']['label'] = '';
$handler->display->display_options['fields']['nothing']['alter']['text'] = '[title]: Commit [revision] on [labels] [attribution_1]';
$handler->display->display_options['fields']['nothing']['alter']['path'] = '#';
$handler->display->display_options['fields']['nothing']['alter']['link_class'] = 'global-author';
$handler->display->display_options['fields']['nothing']['element_label_colon'] = FALSE;
...
$handler->display->display_options['fields']['repo_id']['label'] = '';
$handler->display->display_options['fields']['repo_id']['exclude'] = TRUE;
$handler->display->display_options['fields']['repo_id']['element_label_colon'] = FALSE;
...
$handler->display->display_options['fields']['revision_1']['label'] = '';
$handler->display->display_options['fields']['revision_1']['element_label_colon'] = FALSE;
...
/* Field: Versioncontrol Git Operations: Author (git) */
$handler->display->display_options['fields']['author_1']['id'] = 'author_1';
$handler->display->display_options['fields']['author_1']['table'] = 'versioncontrol_git_operations';
$handler->display->display_options['fields']['author_1']['field'] = 'author';
$handler->display->display_options['fields']['author_1']['label'] = '';
$handler->display->display_options['fields']['author_1']['element_label_colon'] = FALSE;
$handler->display->display_options['fields']['author_1']['plain_text_output'] = 1;
...
$handler->display->display_options['fields']['committer_date']['label'] = '';
$handler->display->display_options['fields']['committer_date']['element_label_colon'] = FALSE;
