...
3. Once enabled, there will be new option within the "text formats" area of the
"administer" area of Drupal.  To get to it, go "text formats" 
(/admin/config/content/formats/), and select "configure" for the "Filtered HTML" 
format.
Within this page make sure that the box for "Link Node Filter" 
is checked (turned on).  
