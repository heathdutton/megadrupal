...
<script type="text/javascript" src="<?php print $script_url; ?>"></script>
  <div class="media-tableau-outer-wrapper" id="media-tableau-<?php print $id; ?>" style="width: <?php print $width; ?>px; height: <?php print $height; ?>px;">
    <div class="media-tableau-preview-wrapper" id="<?php print $wrapper_id; ?>">
      <script type="text/javascript" src="http://public.tableausoftware.com/javascripts/api/viz_v1.js"></script>
      <div class="tableauPlaceholder" style="width:<?php print $width; ?>px; height:<?php print $height; ?>px;">
        <noscript>
          <a href="#"><img alt=" " src="<?php print $image_url_noscript; ?>" style="border: none" /></a>
        </noscript>
        <object class="tableauViz" width="<?php print $width; ?>" height="<?php print $height; ?>" style="display:none;">
          <param name="host_url" value="<?php print urlencode($server . '/'); ?>" />
          <param name="path" value="<?php print $visualization_decoded; ?>" />
          <param name="toolbar" value="yes" />
          <param name="static_image" value="<?php print urlencode($image_url_static); ?>" />
      ...
      <div style="width:<?php print $width; ?>px;height:22px;padding:0px 10px 0px 0px;color:black;font:normal 8pt verdana,helvetica,arial,sans-serif;">
