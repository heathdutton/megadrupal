  ...
  <?php if (!empty($header)): ?>
    ...
    <tr>
      <?php foreach ($header as $field => $label): ?>
        <?php if ($field == 'comment_count'): ?>
          <td class="views-field views-field-time"><?php print l(t('Time'), ''); ?></td>
        <?php endif; ?>
  ...
  <?php foreach ($rows as $row_count => $row): ?>
    <tr <?php if ($row_classes[$row_count]): print 'class="' . implode(' ', $row_classes[$row_count]) . '"';  endif; ?>>
      <?php foreach ($row as $field => $content): ?>
        <?php if ($field == 'comment_count'): ?>
          <td class="views-field views-field-time"><?php print $view->result[$row_count]->shared_time_maximum; ?></td>
        <?php endif; ?>
