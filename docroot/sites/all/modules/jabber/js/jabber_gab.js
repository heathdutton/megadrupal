var Gab = {
    ...
    on_message: function (message) {
        ...
        if (body) {
            ...
            "</span></div>";
            $.post(url, {conv_partner_jid: jid, jabber_message: jabber_message},
                function(data){
...
$(document).ready(function () {
    ...
    $('.chat-input').live('keypress', function (ev) {
        ...
        var jid_id = jid_id.replace('chat-','');
