...
<!--//--><![CDATA[//><!--
  ...
  imce.vars.prvstyle = 'imce_preview'; //preview larger images inline using an image style(imagecache preset).
  ...
  // mce.vars.absurls = 1; //make IMCE return absolute file URLs to external applications.
//--><!]]>
</script>
...
<div id="help-box"><!-- Update help content if you disable any of the extra features above. -->
  ...
  <div id="help-box-content">
    ...
    <ul class="tips">
      <li><?php print t('aSelect a file by clicking the corresponding row in the file list.'); ?></li>
