...
function dupeoff_check_api($text) {

	define('DUPEOFF_USERNAME', variable_get('dupeoff_username', ''));
	define('DUPEOFF_PASSWORD', variable_get('dupeoff_password', ''));
