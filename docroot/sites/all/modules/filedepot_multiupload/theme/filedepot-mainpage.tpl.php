  ...
  <div id="filedepot">
      ...
      <?php if ($show_upload == 'true'): ?>
        <span id="multiuploadlink" class="yui-button yui-link-button">
          <span class="first-child">
            <a class="ctools-use-modal ctools-modal-filedepot-newfile-dialog-style" href="<?php print url('filedepot/nojs/multiupload'); ?>">
              <?php if (variable_get('filedepot_multiupload_multibuttonname') !== 'Multiple Upload'):
                print check_plain(variable_get('filedepot_multiupload_multibuttonname'));
              else:
                print t('Multiple Upload');
              endif; ?>
            </a>
          </span>
        </span>
