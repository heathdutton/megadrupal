    ...
    var tools = {
      ...
      checkImagesLocal: function(ev, images) {
        ...
        if (localImagesCount) {
          ...
          editor.config.drupalImageFromWord.message = 'Some images cannot be pasted together with other content due the security reasons.'
          + '<br />' + 'Please try to paste them separately.';
