<?php
/**
 * @file milli_piyango-block-1.tpl.php
 * This template handles the layout of the Sayisal Loto Block.
 *
 * Variables available:
...
<?php if (!empty($settings['items']['w_six']) && !empty($items['winners']['six']->item(0)->nodeValue)): ?>
  <div class="score">
    <strong><?php print t('Score 6/6:') ?></strong> <?php print check_plain($items['winners']['six']->item(0)->nodeValue); ?>
  </div>
<?php endif; ?>

<?php if (!empty($settings['items']['w_five']) && !empty($items['winners']['five']->item(0)->nodeValue)): ?>
  <div class="score">
    <strong><?php print t('Score 5/6:') ?></strong> <?php print check_plain($items['winners']['five']->item(0)->nodeValue); ?>
  </div>
<?php endif; ?>

<?php if (!empty($settings['items']['w_four']) && !empty($items['winners']['four']->item(0)->nodeValue)): ?>
  <div class="score">
    <strong><?php print t('Score 4/6:') ?></strong> <?php print check_plain($items['winners']['four']->item(0)->nodeValue); ?>
  </div>
<?php endif; ?>

<?php if (!empty($settings['items']['w_three']) && !empty($items['winners']['three']->item(0)->nodeValue)): ?>
  <div class="score">
    <strong><?php print t('Score 3/6:') ?></strong> <?php print check_plain($items['winners']['three']->item(0)->nodeValue); ?>
  </div>
<?php endif; ?>

<?php if (!empty($settings['items']['b_six']) && !empty($items['bonus']['six']->item(0)->nodeValue)): ?>
  <div class="bonus">
    <strong><?php print t('6/6 Bonus:') ?></strong> <?php print check_plain($items['bonus']['six']->item(0)->nodeValue); ?>
  </div>
<?php endif; ?>

<?php if (!empty($settings['items']['b_five']) && !empty($items['bonus']['five']->item(0)->nodeValue)): ?>
  <div class="bonus">
    <strong><?php print t('5/6 Bonus:') ?></strong> <?php print check_plain($items['bonus']['five']->item(0)->nodeValue); ?>
  </div>
<?php endif; ?>

<?php if (!empty($settings['items']['b_four']) && !empty($items['bonus']['four']->item(0)->nodeValue)): ?>
  <div class="bonus">
    <strong><?php print t('4/6 Bonus:') ?></strong> <?php print check_plain($items['bonus']['four']->item(0)->nodeValue); ?>
  </div>
<?php endif; ?>

<?php if (!empty($settings['items']['b_three']) && !empty($items['bonus']['three']->item(0)->nodeValue)): ?>
  <div class="bonus">
    <strong><?php print t('3/6 Bonus:') ?></strong> <?php print check_plain($items['bonus']['three']->item(0)->nodeValue); ?>
  </div>
<?php endif; ?>