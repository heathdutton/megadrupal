...
abstract class MaestroTaskInterface {
  ...
  protected $_taskname;
  protected $_regen_flag;
  protected $_regen_mode;
  ...
  function __construct($task_id=0, $template_id=0) {
    ...
    if ($template_id == 0 && $task_id > 0) {
      ...
      $res->fields('a', array('template_id', 'taskname', 'regenerate', 'regen_all_live_tasks'));
  ...
  function get_regen_flag() {
    return $this->_regen_flag;
  }

  function get_regen_mode() {
    return $this->_regen_mode;
  }
