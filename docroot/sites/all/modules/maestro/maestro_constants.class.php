...
class MaestroContentStatusCodes {
  ...
  static public function getStatusLabel($var=NULL) {
    ...
    $labels[self::STATUS_CANCELLED] = t('Cancelled');
    $labels[self::STATUS_APPROVED] = t('Approved');
...
class MaestroRegenerationFlag {
  CONST REGENERATE_OFF = 0;
  CONST REGENERATE_ON = 1;
  CONST REGENERATE_ALL_LIVE_ON = 3;
  CONST REGENERATE_ON_PLUS_ALL_LIVE = 4;

  static public function getStatusLabel($var=NULL) {
    $labels = array();
    $labels[self::REGENERATE_OFF] = t('Task Regneration Disabled');
    $labels[self::REGENERATE_ON] = t('Regenerate Task Enabled');
    $labels[self::REGENERATE_ALL_LIVE_ON] = t('Regenerate ALL Live Tasks Enabled');
    $labels[self::REGENERATE_ON_PLUS_ALL_LIVE] = t('Regenerate Task and All Live Tasks Enabled');
