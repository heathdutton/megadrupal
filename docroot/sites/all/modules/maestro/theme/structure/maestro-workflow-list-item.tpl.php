...
?>
    <tr class="<?php print $zebra ?>" id="tview<?php print $cntr; ?>" class="">
      ...
      <input title="<?php print t('Copy Template'); ?>" type="image" src="<?php print $module_path; ?>/images/admin/copy.gif" onclick="maestro_copyTemplate(<?php print $rec->id; ?>, '<?php print drupal_get_token('maestro_admin'); ?>');" >&nbsp;
      <input title="<?php print t('Delete Template'); ?>" type="image" src="<?php print $module_path; ?>/images/admin/delete.gif" onclick="maestro_deleteTemplate(<?php print $rec->id; ?>, '<?php print drupal_get_token('maestro_admin'); ?>');" >&nbsp;
