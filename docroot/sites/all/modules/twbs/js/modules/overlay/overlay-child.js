  ...
  attach: function (context, settings) {
    ...
    $('#overlay-disable-message', context)
      .focusin(function () {
        ...
        $('a.element-focusable', this).removeClass('sr-only');
      })
      .focusout(function () {
        $(this).removeClass('overlay-disable-message-focused');
        $('a.element-focusable', this).addClass('sr-only');
      });
  }
};
...
Drupal.overlayChild.behaviors.tabs = function (context, settings) {
  ...
  $('#overlay-tabs > li > a').bind('click.drupal-overlay', function () {
    ...
    $tabsLinks.parent().siblings().removeClass('active').find('sr-only:contains(' + active_tab + ')').appendTo(this);
