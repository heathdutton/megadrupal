 ...
 *
 * This is the exact same script as found in the color module, but the id on
 * line 15 has been altered to match the user profile form.
 */
...
(function ($) {
  ...
  Drupal.behaviors.color = {
    attach: function (context, settings) {
      ...
      var form = $('#user-profile-form .color-form', context).once('color');
      if (form.length == 0) {
        return;
      }
      var inputs = [];
