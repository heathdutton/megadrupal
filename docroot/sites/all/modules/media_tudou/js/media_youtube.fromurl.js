/**
 * @file Create the 'TuDou' tab for the WYSIWYG plugins.
 */

// (function ($) {
// namespace('Drupal.media.browser.plugin');
//
// Drupal.media.browser.plugin.media_tudou = function(mediaBrowser, options) {
// return {
// init: function() {
// tabset = mediaBrowser.getTabset();
// tabset.tabs('add', '#media_tudou', 'TuDou');
// mediaBrowser.listen('tabs.show', function (e, id) {
// if (id == 'media_tudou') {
// // We only need to set this once.
// // We probably could set it upon load.
// if (mediaBrowser.getActivePanel().html() == '') {
// mediaBrowser.getActivePanel().html(options.media_tudou);
// }
// }
// });
// }
...
// //@todo: needs a review.
// Drupal.media.browser.register('media_tudou',
// Drupal.media.browser.plugin.media_tudou, {});
// })(jQuery);
(function($) {
	namespace('media.browser.plugin');

	Drupal.media.browser.plugin.tudou_library = function(mediaBrowser,
			options) {
		...
		return {
			...
			init : function() {
				tabset = mediaBrowser.getTabset();
				tabset.tabs('add', '#tudou_library', 'TuDou');
				var that = this;
				mediaBrowser.listen('tabs.show', function(e, id) {
					if (id == 'tudou_library') {
	...
	Drupal.media.browser.register('tudou_library',
			Drupal.media.browser.plugin.tudou_library);
})(jQuery);
