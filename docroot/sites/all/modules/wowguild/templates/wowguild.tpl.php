...
<div class="<?php print $classes; ?> clearfix"<?php print $attributes; ?>>
  ...
  <div class="content"<?php print $content_attributes; ?>>
		<img src="<?php echo $tabard_url; ?>" class="guild-tabard" />
    <h2><?php print $name; ?></h2>
    
    <div class="guild-level-faction-members">
    <?php print $guild_substring; ?>
    </div>
    <span class="achievements"><?php echo $achievement_points; ?></span>
    <div class="updated_ago"><?php echo $updated_interval; ?></div>
    <!--  END:Copied from Teaser -->
    <?php
      print render($content);
    ?>
    <?php if ($view_mode == 'full'): print($roster); endif; ?>
