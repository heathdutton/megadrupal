<div<?php print $css_id ? " id=\"$css_id\"" : ''; ?> class="layout-three-columns clearfix">
  ...
  <?php if (!empty($content['column_third_alpha'])): ?>
  <div class="column column-third column-alpha">
    <?php print render($content['column_third_alpha']); ?>
  </div>
  <?php endif; ?>
