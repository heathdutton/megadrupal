...
<!-- wrapper start -->
<div id="bottom_frame"><div id="top_frame"><div id="top_container">
  ...
  <header id="header" role="banner" class="clearfix">
    ...
    <div id="rss"><a href="<?php print $base_path ?>rss.xml"><img src="<?php print $base_path ?>sites/all/themes/summer/images/spacer.gif" alt="feed"/></a></div>
