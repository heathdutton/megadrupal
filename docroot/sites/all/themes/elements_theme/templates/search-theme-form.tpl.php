 ...
 */
?>
  	<input type="text" name="search_theme_form" id="edit-search-theme-form-1" size="25" value="" title="Enter the terms you wish to search for." class="form-text" />
	<input type="image" name- "op" alt="Submit" src="http://localhost/drupal6/sites/all/themes/elements/images/search-trans.png" id="searchsubmit"/>
