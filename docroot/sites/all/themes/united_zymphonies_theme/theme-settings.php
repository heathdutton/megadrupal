 ...
 *   The form state.
 */
function united_zymphonies_theme_form_system_theme_settings_alter(&$form, &$form_state) {

  $form['prof_color_settings']['color_scheme'] = array(
    '#type'          => 'select',
    '#title'         => t('Color Scheme'),
    '#default_value' => theme_get_setting('color_scheme', 'united_zymphonies_theme'),
  ...
  $form['prof_settings']['breadcrumbs'] = array(
    ...
    '#default_value' => theme_get_setting('breadcrumbs','united_zymphonies_theme'),
  ...
  $form['prof_settings']['top_social_link']['social_links'] = array(
    ...
    '#default_value' => theme_get_setting('social_links', 'united_zymphonies_theme'),
