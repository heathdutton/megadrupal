...
<div id="page" class="<?php print $classes; ?>"<?php print $attributes; ?>>
  ...
  <header id="header" style="<?php //echo $header_style; ?>>
    ...
    <?php endif; ?>
      ...
      <?php 
      $twitter_url = check_plain(theme_get_setting('twitter_url', 'corp')); 
      $facebook_url = check_plain(theme_get_setting('facebook_url', 'corp')); 
      $linkedin_url = check_plain(theme_get_setting('linkedin_url', 'corp')); 
      $theme_path_social = base_path() . drupal_get_path('theme', 'corp');
      ?>
      <div id="socialbar">
        <ul class="social">
