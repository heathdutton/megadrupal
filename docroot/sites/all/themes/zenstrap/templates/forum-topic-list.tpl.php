 ...
 */
?>
<table class="forum-table table table-striped" id="forum-topic-<?php print $topic_id; ?>">
  <thead>
    ...
    <?php else: ?>
      <td class="replies">
        ...
        <?php if ($topic->new_replies): ?>
          <br />
          <a class="btn btn-mini btn-info" href="<?php print $topic->new_url; ?>"><?php print $topic->new_text; ?></a>
        <?php endif; ?>
      </td>
