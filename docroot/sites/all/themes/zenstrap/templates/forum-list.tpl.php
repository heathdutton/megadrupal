...
<!--           <div class="icon forum-status-<?php print $forum->icon_class; ?>" title="<?php print $forum->icon_title; ?>">
          ...
          </div> -->          <div class="name"><a href="<?php print $forum->link; ?>"><?php print $forum->name; ?></a></div>
      ...
      <?php if (!$forum->is_container): ?>
        <td class="topics">
          ...
          <?php if ($forum->new_topics): ?>
            <br />
            <a class="btn btn-mini btn-info" href="<?php print $forum->new_url; ?>"><?php print $forum->new_text; ?></a>
          <?php endif; ?>
        </td>
