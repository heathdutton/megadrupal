...
/**
 * implement pets_form_system_theme_settings_alter()
 */
function pets_form_system_theme_settings_alter(&$form, $form_state) {
  ...
  $form['options_settings']['pets_tabs'] = array(
    '#type' => 'checkbox',
    '#title' =>  t('Use the ZEN tabs'),
    '#description'   => t('Check this if you wish to replace the default tabs by the ZEN tabs'),
    '#default_value' => theme_get_setting('pets_tabs'),
  );
  $form['options_settings']['pets_breadcrumb'] = array(
    '#type'          => 'fieldset',
    '#title'         => t('Breadcrumb settings'),
    '#attributes'    => array('id' => 'pets-breadcrumb'),
  );
  $form['options_settings']['pets_breadcrumb']['pets_breadcrumb'] = array(
    '#type'          => 'select',
    '#title'         => t('Display breadcrumb'),
    '#default_value' => theme_get_setting('pets_breadcrumb'),
    '#options'       => array(
                          'yes'   => t('Yes'),
  ...
  $form['options_settings']['pets_breadcrumb']['pets_breadcrumb_separator'] = array(
    '#type'          => 'textfield',
    '#title'         => t('Breadcrumb separator'),
    '#description'   => t('Text only. Don’t forget to include spaces.'),
    '#default_value' => theme_get_setting('pets_breadcrumb_separator'),
    '#size'          => 5,
    '#maxlength'     => 10,
    '#prefix'        => '<div id="div-pets-breadcrumb-collapse">', // jquery hook to show/hide optional widgets
  );
  $form['options_settings']['pets_breadcrumb']['pets_breadcrumb_home'] = array(
    '#type'          => 'checkbox',
    '#title'         => t('Show home page link in breadcrumb'),
    '#default_value' => theme_get_setting('pets_breadcrumb_home'),
  );
  $form['options_settings']['pets_breadcrumb']['pets_breadcrumb_trailing'] = array(
    '#type'          => 'checkbox',
    '#title'         => t('Append a separator to the end of the breadcrumb'),
    '#default_value' => theme_get_setting('pets_breadcrumb_trailing'),
    '#description'   => t('Useful when the breadcrumb is placed just before the title.'),
  );
  $form['options_settings']['pets_breadcrumb']['pets_breadcrumb_title'] = array(
    '#type'          => 'checkbox',
    '#title'         => t('Append the content title to the end of the breadcrumb'),
    '#default_value' => theme_get_setting('pets_breadcrumb_title'),
    '#description'   => t('Useful when the breadcrumb is not placed just before the title.'),
    '#suffix'        => '</div>', // #div-pets-breadcrumb-collapse"
  );

  //IE specific settings.
  $form['options_settings']['pets_ie'] = array(
    '#type' => 'fieldset',
    '#title' => t('Internet Explorer Stylesheets'),
    '#attributes' => array('id' => 'pets-ie'),
  );
  $form['options_settings']['pets_ie']['pets_ie_enabled'] = array(
    '#type' => 'checkbox',
    '#title' => t('Enable Internet Explorer stylesheets in theme'),
    '#default_value' => theme_get_setting('pets_ie_enabled'),
    '#description' => t('If you check this box you can choose which IE stylesheets in theme get rendered on display.'),
  );
  $form['options_settings']['pets_ie']['pets_ie_enabled_css'] = array(
    '#type' => 'fieldset',
    '#title' => t('Check which IE versions you want to enable additional .css stylesheets for.'),
    '#states' => array(
      'visible' => array(
        ':input[name="pets_ie_enabled"]' => array('checked' => TRUE),
      ),
    ),
  );
  $form['options_settings']['pets_ie']['pets_ie_enabled_css']['pets_ie_enabled_versions'] = array(
    '#type' => 'checkboxes',
    '#options' => array(
    ...
    '#default_value' => theme_get_setting('pets_ie_enabled_versions'),
  );
...
$form['adv_header']['header_bg_file'] = array(
  ...
  $form['adv_header']['header_bg'] = array(
    ...
    '#element_validate' => array('pets_header_bg_validate'),
  );
  $form['adv_header']['bg_file'] = array(
    '#type' => 'textfield',
    '#title' => t('URL of the body image'),
  ...
  $form['social_settings']['socialicon']['socialicon_display'] = array(
    ...
    '#default_value' => theme_get_setting('socialicon_display' , 'pets'),
    '#description'   => t("Check this option to show Social Icon. Uncheck to hide."),
  );
  $form['social_settings']['socialicon']['twitter_url'] = array(
    '#type' => 'textfield',
    '#title' => t('Twitter Profile URL'),
    '#default_value' => theme_get_setting('twitter_url', 'pets'),
  ...
  $form['social_settings']['socialicon']['facebook_url'] = array(
    ...
    '#default_value'  => theme_get_setting('facebook_url', 'pets'),
  ...
  $form['social_settings']['socialicon']['linkedin_url'] = array(
    ...
    '#default_value' => theme_get_setting('linkedin_url', 'pets'),
 ...
 */
/**
 * implement pets_header_bg_validate
 */
function pets_header_bg_validate($element, &$form_state) {
  global $base_url;
 ...
 */
/**
 * implement pets_background_validate()
 */
function pets_background_validate($element, &$form_state) {
  global $base_url;
