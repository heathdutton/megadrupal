(function ( $ ) {
    ...
    function Prettify( options ) {
        ...
        var view = {
            ...
            _renderFile: function() {
                ...
                var fake = $( '<div><span><a class="button">' + Drupal.t( 'Browse' ) + '</a></span><span class="filetext">' +  Drupal.t( 'No file chosen' ) + '</span></div>' );
    ...
    $(function() {
        $( 'select, input[type="file"]' ).each( function() { new Prettify({ el: this }); });
    });
