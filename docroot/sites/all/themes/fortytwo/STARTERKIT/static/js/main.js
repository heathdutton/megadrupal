(function ( $, Drupal, window, document, undefined ) {
    ...
    Drupal.behaviors.app = {
        attach: function ( context, settings ) {
            ...
            var body = $('body');
            if( body.hasClass( 'layout-adaptive' )) constants.LAYOUT = { fluid: false, adaptive: true };
            else if( body.hasClass( 'layout-fluid' )) constants.LAYOUT = { fluid: true, adaptive: false };
