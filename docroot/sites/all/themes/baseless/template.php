 ...
 *
 */
function baseless_css_alter(&$css) {
  $exclude = array(
 ...
 */
function baseless_breadcrumb($variables) {
 ...
 * @see region.tpl.php
 */
function baseless_preprocess_region(&$variables) {
  // Create the $content variable that templates expect.
  $region = preg_replace('/_/', '-', $variables['elements']['#region']);
  $variables['region_id'] = $region;
  if (($region == 'sidebar-first') || ($region == 'sidebar-second')) {
    $variables['classes_array'][] = 'content-column';
