...
<div id="page-wrapper">
    ...
    <?php if ($main_menu || $secondary_menu || $page['nav']): ?>
      <div id="navigation-section" class="section"><div class="limiter clearfix">
  ...
  <div id="main-content-section" class="section"><div class="limiter clearfix">
    ...
    <div id="content-wrapper" class="content-column clearfix">
