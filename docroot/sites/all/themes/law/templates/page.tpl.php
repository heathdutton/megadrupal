...
/**
 * @file
 * law theme's implementation to display a single Drupal page.
 */
  global $base_url;
    $header_style = '';
...
<div id="page" class="<?php print $classes; ?>"<?php print $attributes; ?>>
  ...
  <header id="header" style="<?php //echo $header_style; ?>">
    ...
    <?php endif; ?>
      ...
      <?php if (theme_get_setting('socialicon_display', 'law')): ?>
      <?php 
      $twitter_url = check_plain(theme_get_setting('twitter_url', 'law')); 
      $facebook_url = check_plain(theme_get_setting('facebook_url', 'law')); 
      $linkedin_url = check_plain(theme_get_setting('linkedin_url', 'law')); 
      $theme_path_social = base_path() . drupal_get_path('theme', 'law');
      ?>
      <div id="socialbar">
        <ul class="social">
  ...
  <?php endif; ?>
  <?php global $base_url;?>
  <!--<div><img id="content-img" src="<?php //print $base_url;?>/sites/all/themes/law/images/banner.jpg"></div>-->
  <div class="clear"></div>
  <div id="content-img" style="<?php echo $header_style; ?>"></div>
  ...
  <div id="main" class="clearfix">
    ...
    <div class="clear"></div>
        ...
        <div id="bottom-columns">
          <?php print law_build_columns( array(
