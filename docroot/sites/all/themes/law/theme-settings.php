 ...
 */
/**
 * implements law_form_system_theme_settings_alter().
 */
function law_form_system_theme_settings_alter(&$form, $form_state) {
  ...
  $form['options_settings']['law_tabs'] = array(
    '#type' => 'checkbox',
    '#title' =>  t('Use the ZEN tabs'),
    '#description'   => t('Check this if you wish to replace the default tabs by the ZEN tabs'),
    '#default_value' => theme_get_setting('law_tabs'),
  );
  $form['options_settings']['law_breadcrumb'] = array(
    '#type'          => 'fieldset',
    '#title'         => t('Breadcrumb settings'),
    '#attributes'    => array('id' => 'law-breadcrumb'),
  );
  $form['options_settings']['law_breadcrumb']['law_breadcrumb'] = array(
    '#type'          => 'select',
    '#title'         => t('Display breadcrumb'),
    '#default_value' => theme_get_setting('law_breadcrumb'),
    '#options'       => array(
                          'yes'   => t('Yes'),
  ...
  $form['options_settings']['law_breadcrumb']['law_breadcrumb_separator'] = array(
    '#type'          => 'textfield',
    '#title'         => t('Breadcrumb separator'),
    '#description'   => t('Text only. Don’t forget to include spaces.'),
    '#default_value' => theme_get_setting('law_breadcrumb_separator'),
    '#size'          => 5,
    '#maxlength'     => 10,
    '#prefix'        => '<div id="div-law-breadcrumb-collapse">', // jquery hook to show/hide optional widgets
  );
  $form['options_settings']['law_breadcrumb']['law_breadcrumb_home'] = array(
    '#type'          => 'checkbox',
    '#title'         => t('Show home page link in breadcrumb'),
    '#default_value' => theme_get_setting('law_breadcrumb_home'),
  );
  $form['options_settings']['law_breadcrumb']['law_breadcrumb_trailing'] = array(
    '#type'          => 'checkbox',
    '#title'         => t('Append a separator to the end of the breadcrumb'),
    '#default_value' => theme_get_setting('law_breadcrumb_trailing'),
    '#description'   => t('Useful when the breadcrumb is placed just before the title.'),
  );
  $form['options_settings']['law_breadcrumb']['law_breadcrumb_title'] = array(
    '#type'          => 'checkbox',
    '#title'         => t('Append the content title to the end of the breadcrumb'),
    '#default_value' => theme_get_setting('law_breadcrumb_title'),
    '#description'   => t('Useful when the breadcrumb is not placed just before the title.'),
    '#suffix'        => '</div>', // #div-law-breadcrumb-collapse"
  );

  //IE specific settings.
  $form['options_settings']['law_ie'] = array(
    '#type' => 'fieldset',
    '#title' => t('Internet Explorer Stylesheets'),
    '#attributes' => array('id' => 'law-ie'),
  );
  $form['options_settings']['law_ie']['law_ie_enabled'] = array(
    '#type' => 'checkbox',
    '#title' => t('Enable Internet Explorer stylesheets in theme'),
    '#default_value' => theme_get_setting('law_ie_enabled'),
    '#description' => t('If you check this box you can choose which IE stylesheets in theme get rendered on display.'),
  );
  $form['options_settings']['law_ie']['law_ie_enabled_css'] = array(
    '#type' => 'fieldset',
    '#title' => t('Check which IE versions you want to enable additional .css stylesheets for.'),
    '#states' => array(
      'visible' => array(
        ':input[name="law_ie_enabled"]' => array('checked' => TRUE),
      ),
    ),
  );
  $form['options_settings']['law_ie']['law_ie_enabled_css']['law_ie_enabled_versions'] = array(
    '#type' => 'checkboxes',
    '#options' => array(
    ...
    '#default_value' => theme_get_setting('law_ie_enabled_versions'),
  );
...
$form['adv_header']['header_bg_file'] = array(
  ...
  $form['adv_header']['header_bg'] = array(
    ...
    '#element_validate' => array('law_header_bg_validate'),
  );
$form['adv_header']['bg_file'] = array(
  ...
  $form['adv_header']['background'] = array(
    ...
    '#element_validate' => array('law_background_validate'),
  );
  /* Add Social Links */
$form['social_settings']['socialicon'] = array(
  ...
  $form['social_settings']['socialicon']['socialicon_display'] = array(
    ...
    '#default_value' => theme_get_setting('socialicon_display' , 'law'),
    '#description'   => t("Check this option to show Social Icon. Uncheck to hide."),
  );
  $form['social_settings']['socialicon']['twitter_url'] = array(
    '#type' => 'textfield',
    '#title' => t('Twitter Profile URL'),
    '#default_value' => theme_get_setting('twitter_url', 'law'),
  ...
  $form['social_settings']['socialicon']['facebook_url'] = array(
    ...
    '#default_value' => theme_get_setting('facebook_url', 'law'),
  ...
  $form['social_settings']['socialicon']['linkedin_url'] = array(
    ...
    '#default_value' => theme_get_setting('linkedin_url', 'law'),
 ...
 */
/**
 * implement law_header_bg_validate().
 */
function law_header_bg_validate($element, &$form_state) {
  global $base_url;
 ...
 */
/**
 * implement law_background_validate().
 */
function law_background_validate($element, &$form_state) {
  global $base_url;
