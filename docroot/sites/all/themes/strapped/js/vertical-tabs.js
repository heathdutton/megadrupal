    ...
    Drupal.behaviors.verticalTabs = {
        attach: function (context) {
            $('.vertical-tabs-panes', context).once('vertical-tabs', function () {
                ...
                // Add the bootstrap column class @todo make this adjustable.
                ...
                var $fieldsets = $('> .panel', this);
                if ($fieldsets.length == 0) {
                    return;
                }

                // Create the tab column.
                var tab_list = $('<ul class="nav nav-tabs vertical-tabs-list col-md-3"></ul>');
                $(this).wrap('<div class="tabbable tabs-left vertical-tabs row clearfix"></div>').before(tab_list);

                // Transform each fieldset into a tab.
                $fieldsets.each(function () {
                    var vertical_tab = new Drupal.verticalTab({
                        title: $('> .panel-heading', this).text(),
                        fieldset: $(this)
                    });
