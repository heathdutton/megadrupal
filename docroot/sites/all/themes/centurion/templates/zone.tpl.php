 ...
 * - $enabled: Flag to detect if the zone was enabled/disabled via the theme
 ...
 * - $attributes: a string containing the relevant class & id data for a
 *      container
 *
 * Helper Variables
...
<div id="<?php print $zid;?>-outer-wrapper" class="clearfix">
  <?php endif; ?>
  <div class="<?php print $classes; ?>" <?php print $attributes;?>> <?php print render($regions); ?> </div>
  <?php if($wrapper): ?>
</div>
<?php endif; ?>
<?php endif; ?>
