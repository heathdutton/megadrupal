...
<head profile="<?php print $grddl_profile; ?>">
  ...
  <!--[if lte IE 8]>
     <script type="text/javascript" src="<?php print base_path() . $directory; ?>/js/DD_roundies_0.0.2a.js"></script>
     <script type="text/javascript" src="<?php print base_path() . $directory; ?>/js/ie.js"></script>
     <![endif]-->
