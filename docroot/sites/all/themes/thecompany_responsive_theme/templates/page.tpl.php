...
<div id="header_wrapper">
  ...
  <div id="container">
    ...
    <div id="content">
      ...
      <?php if (theme_get_setting('breadcrumbs', 'thecompany_responsive_theme')): ?>
        <div id="breadcrumbs">
...
<div id="footer">
  ...
  <div class="social-media-wrapper">
   <?php if (theme_get_setting('social_links', 'thecompany_responsive_theme')): ?>
      <div id="social-media-icons">
       <ul>
        <li><a class="rss" href="<?php print $front_page; ?>rss.xml">rss</a></li>
        <li><a class="facebook" href="<?php echo theme_get_setting('facebook_url', 'thecompany_responsive_theme'); ?>" target="_blank" rel="me">facebook</a></li>
        <li><a class="twitter"> href="<?php echo theme_get_setting('twitter_url', 'thecompany_responsive_theme'); ?>" target="_blank" rel="me">twitter</a></li>
        <li><a class="gplus" href="<?php echo theme_get_setting('gplus_url', 'thecompany_responsive_theme'); ?>" target="_blank" rel="me">Gplus</a></li>
        <li><a class="linkedin" href="<?php echo theme_get_setting('linkedin_url', 'thecompany_responsive_theme'); ?>" target="_blank" rel="me">Linked in</a></li>
        <li><a class="dribbble" href="<?php echo theme_get_setting('dribbble_url', 'thecompany_responsive_theme'); ?>" target="_blank" rel="me">Dribbble</a></li>
        <li><a class="vimeo" href="<?php echo theme_get_setting('vimeo_url', 'thecompany_responsive_theme'); ?>" target="_blank" rel="me">Vimeo</a></li>
        <li><a class="youtube" href="<?php echo theme_get_setting('youtube_url', 'thecompany_responsive_theme'); ?>" target="_blank" rel="me">Youtube</a></li>
       </ul>
      </div>
    <?php endif; ?>
  </div>
