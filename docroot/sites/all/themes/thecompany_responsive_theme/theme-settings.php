 ...
 *   The form state.
 */
function thecompany_responsive_theme_form_system_theme_settings_alter(&$form, &$form_state) {
  ...
  $form['prof_settings']['breadcrumbs'] = array(
    ...
    '#default_value' => theme_get_setting('breadcrumbs','thecompany_responsive_theme'),
  ...
  $form['prof_settings']['top_social_link']['social_links'] = array(
    ...
    '#default_value' => theme_get_setting('social_links', 'thecompany_responsive_theme'),
  ...
  $form['prof_settings']['top_social_link']['twitter_url'] = array(
    ...
    '#default_value' => theme_get_setting('twitter_url', 'thecompany_responsive_theme'),
  ...
  $form['prof_settings']['top_social_link']['facebook_url'] = array(
    ...
    '#default_value' => theme_get_setting('facebook_url', 'thecompany_responsive_theme'),
  ...
  $form['prof_settings']['top_social_link']['gplus_url'] = array(
    ...
    '#default_value' => theme_get_setting('gplus_url', 'thecompany_responsive_theme'),
  ...
  $form['prof_settings']['top_social_link']['linkedin_url'] = array(
    ...
    '#default_value' => theme_get_setting('linkedin_url', 'thecompany_responsive_theme'),
  ...
  $form['prof_settings']['top_social_link']['dribbble_url'] = array(
    ...
    '#default_value' => theme_get_setting('dribbble_url', 'thecompany_responsive_theme'),
    '#description' => t("Enter your Dribbble profile url."),
  );
  $form['prof_settings']['top_social_link']['vimeo_url'] = array(
    '#type' => 'textfield',
    '#title' => t('Vimeo profile url'),
    '#default_value' => theme_get_setting('vimeo_url', 'thecompany_responsive_theme'),
  ...
  $form['prof_settings']['top_social_link']['youtube_url'] = array(
    ...
    '#default_value' => theme_get_setting('youtube', 'thecompany_responsive_theme'),
