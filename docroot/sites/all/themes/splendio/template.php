 ...
 */
function splendio_breadcrumb($variables) {
 ...
 */
function splendio_preprocess_page(&$vars) {
 ...
 */
function splendio_menu_local_tasks(&$variables) {
  $output = '';
 ...
 */
function splendio_form_search_block_form_alter(&$form, &$form_state) {
 ...
 */
function splendio_preprocess_node(&$vars) {
  // Grab the node object.
  $node = $vars['node'];
  // Make individual variables for the parts of the date.
  $vars['date'] = format_date($node->created, 'custom', 'M j, Y');
