...
Available variables:
    ...
    * $classes: String of classes that can be used to style contextually through CSS. It can be manipulated through the variable $classes_array from preprocess functions. The default values can be one or more of the following:
          o comment: The current template type, i.e., "theming hook".
          o comment-by-anonymous: Comment by an unregistered user.
          o comment-by-node-author: Comment by the author of the parent node.
          o comment-preview: When previewing a new or edited comment.

      The following applies only to viewers who are registered users:
          o comment-unpublished: An unpublished comment visible only to administrators.
          o comment-by-viewer: Comment by the user currently viewing the page.
          o comment-new: New comment since last the visit.
...
<div class="comment"<?php print $attributes; ?>>
  <?php if($picture) { ?> <div class="profile">
  <?php print $picture; ?></div><?php } ?>
  ...
  <h3 class="commenttitle" <?php print $title_attributes; ?>><?php print $title; ?></h3>
