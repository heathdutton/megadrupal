...
<?php
  ...
  // Work out table classes:
  $table_classes = implode(' ', theme_get_setting('bh_bootstrap_table__classes'));
?>
<table id="blocks" class="sticky-enabled<?php print $table_classes != '' ? ' ' . $table_classes : ''; ?>">
  <thead>
    <tr>
