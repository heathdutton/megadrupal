...
<article id="node-<?php print $node->nid; ?>" class="<?php print $classes; ?> clearfix"<?php print $attributes; ?>>
  ...
  <?php $login_url = '/user/login?destination=node/' . $node->nid . '%23comment-form'; ?>
  <?php $register_url = '/user/register?destination=node/' . $node->nid . '%23comment-form'; ?>
    <div class="custom-login-links"><a href="<?php print $login_url ?>">Log in</a>
      or <a href="<?php print $register_url ?>">register</a> to post comments</div>
  <?php endif; ?>
  <?php if (isset($content['comments']['comments'])) :?>
