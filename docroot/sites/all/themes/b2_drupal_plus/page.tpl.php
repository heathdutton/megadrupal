...
<div class="b2-header">
    ...
    <div class="b2-header-center">
        <div class="b2-header-jpeg"></div>
    </div>
    </div>
<div class="b2-header-wrapper">
<div class="b2-header-inner">
<div class="b2-textblock"> </div>
<div class="b2-logo">
     <?php   
     
         if(!empty($logo))
         {
            if (!empty($site_name)) { echo '<h1 class="b2-logo-name"><a href="'.check_url($front_page).'" title = "'.$site_name.(!empty($site_slogan) ? ' - '.$site_slogan : '').'"><img src="'.$logo.'" alt="'.$site_name.(!empty($site_slogan) ? ' - '.$site_slogan : '').'" /></a></h1>'; }
         }
         else
         {
...
<div class="cleared"></div>
<p class="b2-page-footer">Designed by <a href="http://www.b2hq.com">b2</a>.</p>
