...
function b2_drupal_plus_breadcrumb($variables) {
 ...
 * @ingroup themeable
 */
function b2_drupal_plus_button($variables) {
 ...
 */
function b2_drupal_plus_preprocess_page(&$vars) {
 ...
 * @ingroup themeable
 */
function b2_drupal_plus_menu_local_task($variables) {
 ...
 */
function b2_drupal_plus_feed_icon($variables) {
 ...
 * @ingroup themeable
 */
function b2_drupal_plus_node_preview($variables) {
  $node = $variables['node'];
