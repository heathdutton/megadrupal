...
Red Salute is a clean theme with a div based, fixed width, 2-column layout (content+right sidebar).
...
------------
 ...
 1. Download Lightword from http://drupal.org/project/redsalute
