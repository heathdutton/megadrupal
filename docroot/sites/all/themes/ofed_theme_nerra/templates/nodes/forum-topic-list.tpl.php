 ...
 * - $topic->new_text: Text containing the translated, properly
 *   pluralized count.
 * - $topic->created: An outputtable string represented when
    ...
    <?php foreach ($topics as $topic): ?>
      <tr class="<?php print $topic->zebra;?>">
        ...
        <td class="title">
          <div>
            <?php
              // Use check_plain even it's safe to output.
              // Otherwise, PAreview report cry :(
              print check_plain($topic->title);
            ?>
          </div>
          <div>
