...
// Set grids responsive stylesheets
  drupal_add_css(drupal_get_path('theme','pure_css').'/css/drupal/drupal-system-min.css', array('group' => CSS_SYSTEM, 'every_page' => TRUE, 'weight' => -2));
  drupal_add_css(drupal_get_path('theme','pure_css').'/css/drupal/drupal-default-min.css', array('group' => CSS_DEFAULT, 'every_page' => TRUE, 'weight' => -2));

  if(theme_get_setting('css_zone')) {
    drupal_add_css('http://yui.yahooapis.com/pure/0.6.0/pure-min.css', array('group' => CSS_THEME, 'every_page' => TRUE, 'weight' => -3, 'preprocess' => FALSE));
  } else {
    drupal_add_css(drupal_get_path('theme','pure_css').'/css/yui/pure-min.css', array('group' => CSS_THEME, 'every_page' => TRUE, 'weight' => -3));
  }
  if(theme_get_setting('grid_responsive') == '1') {
    if(theme_get_setting('css_zone')) {
      ...
      drupal_add_css(drupal_get_path('theme','pure_css').'/css/yui/grids-responsive-old-ie-min.css', array('group' => CSS_THEME, 'browsers' => array('IE' => 'IE 8', '!IE' => FALSE), 'every_page' => TRUE, 'weight' => -2));
      drupal_add_css(drupal_get_path('theme','pure_css').'/css/yui/grids-responsive-min.css', array('group' => CSS_THEME, 'browsers' => array('IE' => 'gt IE 8'), 'every_page' => TRUE, 'weight' => -2));
    }
  }
...
if (theme_get_setting('slideshow_display')) {
  if (drupal_is_front_page() || theme_get_setting('slideshow_all')) {
    drupal_add_css(drupal_get_path('theme','pure_css').'/_custom/slider.css', array('group' => CSS_THEME, 'every_page' => TRUE, 'weight' => -1));
    drupal_add_js(drupal_get_path('theme', 'pure_css').'/js/jquery.flexslider-min.js', array('group' => JS_THEME));
    drupal_add_js(drupal_get_path('theme', 'pure_css').'/js/slide.js', array('group' => JS_THEME));
  }
}
