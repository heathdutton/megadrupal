...
<!--[if IE 9]>
<script type="text/javascript" async src="<?php print $base_path . $path_to_pure_css ?>/js/classList.min.js"></script>
<![endif]-->
<!--[if gte IE 9]><!-->
<script type="text/javascript" async src="<?php print $base_path . $path_to_pure_css ?>/js/toggles.min.js"></script>
<!--<![endif]-->
</body>
</html>