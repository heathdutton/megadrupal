  ...
  <div id="main-wrapper" class="wrapper">
    <div class="container <?php print $grid; ?> clearfix">
      <div class="container-inner <?php print nucleus_group_class("content, sidebar_second");?> ">
        ...
        <?php if($panel_first): ?>
        <!-- PANEL FIRST -->
        <div id="panel-first-wrapper" class="wrapper panel panel-first"> <?php print $panel_first;?> </div>
        <!-- //PANEL FIRST -->
        <?php endif; ?>
        <!-- MASS TOP -->
          <?php if ($mass_top = render($page['mass_top'])): ?>
          <div id="mass-top" class="wrapper <?php print nucleus_group_class("content, sidebar_second");?>">
        ...
        <div class="grid-inner clearfix">
          <div class="logo">
            ...
            <div id="name-and-slogan" class="hgroup">
              ...
              <?php endif; ?>
              <?php if ($site_slogan): ?>
              <p class="site-slogan"><span><?php print $site_slogan; ?></span></p>
              <?php endif; ?>
            </div>
            <?php endif; ?>
