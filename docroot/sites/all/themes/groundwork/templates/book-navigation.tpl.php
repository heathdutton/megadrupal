...
/**
 * @file
 * Groundwork Framework's implementation to navigate books. Presented under nodes that
...
<?php if ($tree || $has_links): ?>
  <div id="book-navigation-<?php print $book_id; ?>" class="book-navigation<?php print $noceda_hide_book_navigation_hide; ?>">
    <?php print $tree; ?>
