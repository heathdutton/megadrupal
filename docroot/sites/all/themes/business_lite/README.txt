WHAT IS Business Lite?
------------------------

Business Lite is a Professional Responsive Business theme perfect for any business.

FEATURES
--------

 * Business Lite has an in build slideshow feature

 * To enable/configure slideshow do the following steps
   
   * Goto admin/appearance/settings/business_lite.
   * Select Banner management and upload the slideshow images and click 'Save configuration'.

 * In Business Lite theme a fixed size can be set for content images so that content alignment won't be affected
 * To do this use following steps
   ...
   * You can add a new style using Add Style Option
     ...
     * For required content type click manage display tab(path for content type article : admin/structure/types/manage/article/display)
...
------------
 ...
 1. Download Business Blog from http://drupal.org/project/business_lite
...
Full documentation on using Business Blog:
  http://www.freedrupalthemes.net/docs/business_lite

Drupal theming documentation in the Theme Guide:
  http://drupal.org/theme-guide
  
Business Blog demo site
