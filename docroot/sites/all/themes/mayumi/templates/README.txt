...
* page-with-wrapper.tpl.php
  ...
  #billboard, #main, #supplement, #appendix, #rider, and #footer sections. These
  are used to style these containers with a full-width background. Copy the file
  to this folder and rename to page.tpl.php

* block-content-with-wrapper.tpl.php

  Wraps the block contents with <div class="block block-content"></div>. Used if
  you want to target the syle of block contents. Copy the file to this folder
  and rename to block.tpl.php

* region-no-wrapper.tpl.php

  In creating additional regions with the desire to not wrap the blocks in div,
  this template can be used. Copy the file to this folderand rename to
