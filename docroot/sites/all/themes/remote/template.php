 ...
 */
function remote_preprocess_html(&$vars) {
  ...
  $media_queries_css = array(
    'remote.responsive.style.css',
    'remote.responsive.gpanels.css'
  );
  load_subtheme_media_queries($media_queries_css, 'remote'); // Replace 'footheme' with your themes name
