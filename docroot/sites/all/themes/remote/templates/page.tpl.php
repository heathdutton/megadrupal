...
<div id="page-wrapper"><div id="page">
  ...
  <div id="header-wrapper"><div class="container clearfix">
    <header class="clearfix<?php print $linked_site_logo ? ' with-logo' : ''; ?>" role="banner">
      <div id="white-frame">
	  <!-- header inner wrapper starts -->	  
	   <div id="header-inner-wrapper">
      <div id="branding">
        <?php if ($linked_site_logo): ?>
          <div id="logo" class="right"><?php print $linked_site_logo; ?></div>
        <?php endif; ?>
        
        <span id ="small-text" class="title"> <?php print t('Lorem Ipsum'); ?> </span>
  ...
  <?php if ($page['four_first'] || $page['four_second'] || $page['four_third'] || $page['four_fourth']): ?>
    <div id="footer-panels-wrapper"><div class="container clearfix">
      <div class="four-4x25 gpanel clearfix">
		<div class="left" id="region-four-first"><?php print render($page['four_first']); ?></div>
        
        <div class="right" id="region-four-second"><?php print render($page['four_second']); ?></div>
