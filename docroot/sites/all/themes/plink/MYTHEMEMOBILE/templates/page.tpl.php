...
<!-- Start MOBILE THEME. //-->
	...
	<div id="container" class="content-container clearfix" data-role="page">
		
		<div data-role="header" data-fullscreen="true" data-theme="d" class="clearfix header-wrapper">
  	...
  	<?php print render($page['header']); ?>		  
		...
		<div id="primary" class="clearfix" data-role="content">
