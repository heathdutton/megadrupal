...
<div id="wrapper">
        ...
        <div class="logo">
         ...
         <div>
          <div class="header_right">
            ...
            <?php if (theme_get_setting('social_links', 'corporate_corp')): ?>
              <div class="social-icons">
               <ul>
                <li><a href="<?php print $front_page; ?>/rss.xml"><img src="<?php print base_path() . drupal_get_path('theme', 'corporate_corp') . '/images/rss.png'; ?>" alt="RSS Feed"/></a></li>
                <li><a href="http://www.facebook.com/<?php echo theme_get_setting('facebook_username', 'corporate_corp'); ?>" target="_blank" rel="me"><img src="<?php print base_path() . drupal_get_path('theme', 'corporate_corp') . '/images/facebook.png'; ?>" alt="Facebook"/></a></li>
                <li><a href="http://www.twitter.com/<?php echo theme_get_setting('twitter_username', 'corporate_corp'); ?>" target="_blank" rel="me"><img src="<?php print base_path() . drupal_get_path('theme', 'corporate_corp') . '/images/twitter.png'; ?>" alt="Twitter"/></a></li>
               </ul>
              </div>
            <?php endif; ?>
           </div>
 ...
 <div id="page-container">
  ...
  <div id="content">
  <?php if (theme_get_setting('breadcrumbs', 'corporate_corp')): ?><div class="breadcrumb"><?php if ($breadcrumb): print $breadcrumb; endif;?></div><?php endif; ?>
...
<?php endif; ?>
  ...
  <?php if ($page['footer_first'] || $page['footer_second'] || $page['footer_third']): ?>
   ...
   <?php if (theme_get_setting('footer_copyright', 'corporate_corp') || theme_get_setting('footer_credits', 'corporate_corp')): ?>
    <div id="footer">
      <div class="footer_wrapper">
       <?php print render($page['footer']) ?>
      <?php if (theme_get_setting('footer_copyright', 'corporate_corp')): ?>
        <div class="copyright"><?php print t('Copyright'); ?> &copy; <?php echo date("Y"); ?>, <?php print $site_name; ?>.</div>
      <?php endif; ?>
      <?php if (theme_get_setting('footer_credits', 'corporate_corp')): ?>
