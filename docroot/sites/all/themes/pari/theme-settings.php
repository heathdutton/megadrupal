...
function pari_form_system_theme_settings_alter(&$form, &$form_state) {
	...
	$form['pari_settings']['tabs']['update'] = array(
		...
		'#description'   => t("<strong>Please refresh this page to reload theme update information</strong><br />
		Current Pari Theme Version: 7.2<br><img src='http://www.drupar.com/images/theme-update/pari-update.jpg'><br /><a href='https://www.drupal.org/project/pari' target='_blank'>Download latest version</a> || <a href='http://www.drupar.com/pari-theme-documentation/update-theme' target='_blank'>How to update theme</a>"),
		'#collapsible' => True,
		'#collapsed' => True,
	);
