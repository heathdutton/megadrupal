 ...
 */
function easybreeze_preprocess_html(&$variables, $hook) {
...
function easybreeze_preprocess_page(&$variables, $hook) {
 ...
 */
/* -- Delete this line if you want to use this function
function easybreeze_preprocess_node(&$variables, $hook) {
  $variables['sample_variable'] = t('Lorem ipsum.');
 ...
 */
/* -- Delete this line if you want to use this function
function easybreeze_preprocess_comment(&$variables, $hook) {
  $variables['sample_variable'] = t('Lorem ipsum.');
}
// */
 ...
 */
/* -- Delete this line if you want to use this function
function easybreeze_preprocess_block(&$variables, $hook) {
 ...
 */
function easybreeze_preprocess_region(&$variables, $hook) {
