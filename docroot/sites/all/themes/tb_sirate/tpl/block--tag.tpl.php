 ...
 */
?>
<div id="<?php print $block_html_id; ?>" class="<?php print $classes; ?> block-tag"<?php print $attributes; ?>>  
  <div class="block-inner clearfix">
    <?php print render($title_prefix); ?>
    <?php if ($block->subject): ?>
      <h2<?php print $title_attributes; ?>><?php print $block->subject; ?><span class="tag">&nbsp;</span></h2>
    <?php endif; ?>
