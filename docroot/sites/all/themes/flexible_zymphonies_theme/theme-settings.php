 ...
 *   The form state.
 */
function flexible_zymphonies_theme_form_system_theme_settings_alter(&$form, &$form_state) {
  ...
  $form['zymphonies_theme_settings']['breadcrumbs'] = array(
    ...
    '#default_value' => theme_get_setting('breadcrumbs','flexible_zymphonies_theme'),
  ...
  $form['zymphonies_theme_settings']['top_social_link']['social_links'] = array(
    ...
    '#default_value' => theme_get_setting('social_links', 'flexible_zymphonies_theme'),
  ...
  $form['zymphonies_theme_settings']['top_social_link']['twitter_profile_url'] = array(
    '#type' => 'textfield',
    '#title' => t('Twitter URL'),
    '#default_value' => theme_get_setting('twitter_profile_url', 'flexible_zymphonies_theme'),
  ...
  $form['zymphonies_theme_settings']['top_social_link']['pinterest_profile_url'] = array(
    ...
    '#default_value' => theme_get_setting('pinterest_profile_url', 'flexible_zymphonies_theme'),
    '#description' => t("Enter your Linkedin Pinterest URL."),
  );
  $form['zymphonies_theme_settings']['top_social_link']['youtube_profile_url'] = array(
    '#type' => 'textfield',
    '#title' => t('Youtube URL'),
    '#default_value' => theme_get_setting('youtube_profile_url', 'flexible_zymphonies_theme'),
