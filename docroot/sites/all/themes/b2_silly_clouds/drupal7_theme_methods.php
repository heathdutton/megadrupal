...
function b2_silly_clouds_breadcrumb($variables) {
  ...
  if (!empty($breadcrumb)) {
    ...
    $output .= '<div class="breadcrumb b2-postcontent">' . implode(' » ', $breadcrumb) . '</div>';
    return $output;
  }
}
 ...
 * @ingroup themeable
 */
function b2_silly_clouds_button($variables) {
 ...
 */
function b2_silly_clouds_preprocess_page(&$vars) {
 ...
 * @ingroup themeable
 */
function b2_silly_clouds_menu_local_task($variables) {
 ...
 */
function b2_silly_clouds_feed_icon($variables) {
 ...
 * @ingroup themeable
 */
function b2_silly_clouds_node_preview($variables) {
  $node = $variables['node'];
