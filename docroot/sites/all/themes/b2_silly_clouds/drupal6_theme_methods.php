...
function b2_silly_clouds_menu_local_task($link, $active = FALSE) {
  $active_class = "";
  if ($active) {
    $active_class .= "active ";
  }
 ...
 *   A descriptive title of the feed.
  */
function b2_silly_clouds_feed_icon($url, $title) {
 ...
 */
function b2_silly_clouds_preprocess_comment_wrapper(&$vars) {
