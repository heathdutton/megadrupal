README.TXT // ABC responsive theme for Drupal 7.
...
ABOUT THE ABC THEME:
-------------------------------------------------------------------------+
ABC is an advanced responsive, "mobile first", HTML5 theme with layout and 
...
- 16 block regions;
- Many color options for: logo, background, titles, blocks, menu items, etc. 
  + custom settings;
...
- Buildt in multi-level drop-down menu, left, center or right positioned;
...
- Rounded corners - option to have rounded corners in all browsers but older IE;
...
-------------------------------------------------------------------------+
1) Place the abc directory into your themes directory (sites/all/themes/abc).
2) Enable the ABC theme (/admin/appearance).
3) You can configure the theme's settings at /admin/appearance/settings/abc. 


UPGRADING to a new version of ABC theme
-------------------------------------------------------------------------+
1. If possible, log on as administrator user. 
2. Put the site in "Off-line" mode.
3. Check "Rebuild theme registry on every page" at /admin/appearance/settings/abc
4. Place the abc directory into your themes directory (sites/all/themes/abc).
...
you should delete all the abc records in the data base.
...
- 0 Point (https://www.drupal.org/project/zeropoint) - a very customizable HTML5 theme
...
I can also be contacted for paid customizations of ABC theme as well as
