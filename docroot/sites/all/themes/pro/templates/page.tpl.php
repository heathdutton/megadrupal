...
/**
 *  @file
 *  Pro theme's implementation to display a single Drupal page.
 */
global $base_url;
  $header_style = '';
...
<div id="page" class="<?php print $classes; ?>"<?php print $attributes; ?>>
  ...
  <header id="header" style="<?php //echo $header_style; ?>>
    ...
    <?php endif; ?>
      ...
      <?php if (theme_get_setting('socialicon_display', 'pro')): ?>
      <?php 
      $twitter_url = check_plain(theme_get_setting('twitter_url', 'pro')); 
      $facebook_url = check_plain(theme_get_setting('facebook_url', 'pro')); 
      $linkedin_url = check_plain(theme_get_setting('linkedin_url', 'pro')); 
      $theme_path_social = base_path() . drupal_get_path('theme', 'pro');
      ?>
      <div id="socialbar">
        <ul class="social">
