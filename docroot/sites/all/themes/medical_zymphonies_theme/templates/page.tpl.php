...
<div id="header_wrapper">
  ...
  <header id="header" class="clearfix">
    ...
    <div class="top_right"><?php print render($page['search']) ?></div>
  ...
  <div class="menu-wrap">
    <div class="full-wrap clearfix">
      ...
      <!-- Social Links -->
      <?php if (theme_get_setting('social_links', 'medical_zymphonies_theme')): ?>
        <span class="social-icons">
         <ul>
          <li><a class="fb" href="<?php echo theme_get_setting('facebook_profile_url', 'medical_zymphonies_theme'); ?>" target="_blank" rel="me"><i class="fa fa-facebook"></i></a></li>
          <li><a class="twitter" href="<?php echo theme_get_setting('twitter_profile_url', 'medical_zymphonies_theme'); ?>" target="_blank" rel="me"><i class="fa fa-twitter"></i></a></li>
          <li><a class="gplus" href="<?php echo theme_get_setting('gplus_profile_url', 'medical_zymphonies_theme'); ?>" target="_blank" rel="me"><i class="fa fa-google-plus"></i></a></li>
          <li><a class="linkedin" href="<?php echo theme_get_setting('linkedin_profile_url', 'medical_zymphonies_theme'); ?>" target="_blank" rel="me"><i class="fa fa-linkedin"></i></a></li>
          <li><a class="pinterest" href="<?php echo theme_get_setting('pinterest_profile_url', 'medical_zymphonies_theme'); ?>" target="_blank" rel="me"><i class="fa fa-pinterest"></i></a></li>
          <li><a class="youtube" href="<?php echo theme_get_setting('youtube_profile_url', 'medical_zymphonies_theme'); ?>" target="_blank" rel="me"><i class="fa fa-youtube"></i></a></li>
    ...
    <div class="container-wrap">
      <div class="content-sidebar-wrap">
        <div id="content">
          ...
          <?php if (theme_get_setting('breadcrumbs', 'medical_zymphonies_theme')): ?>
            <div id="breadcrumbs">
